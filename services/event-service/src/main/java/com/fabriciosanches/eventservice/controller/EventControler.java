...
public class EventControler {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
            ...
            content = @Content(
                    ...
                    examples = @ExampleObject(name = "novoEvento", value = "{\"nome\":\"Show da ADA\",\"data\":\"10/12/2026\",\"hora\":\"20:00:00\",\"local\":\"Teatro Central\",\"capacidade\":1500.0}")))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Evento criado com sucesso", content = @Content(
                    ...
                    examples = @ExampleObject(value = "{\"id\":1,\"nome\":\"Show da ADA\",\"data\":\"10/12/2026\",\"hora\":\"20:00:00\",\"local\":\"Teatro Central\",\"capacidade\":1500.0}"))),
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
            ...
            content = @Content(
                    schema = @Schema(implementation = EventRequestDTO.class),
                    examples = @ExampleObject(name = "eventoAtualizado", value = "{\"nome\":\"Peça de Teatro Premium\",\"data\":\"12/12/2026\",\"hora\":\"21:30:00\",\"local\":\"Auditório Principal\",\"capacidade\":950.0}")))
    @ApiResponses(value = {
